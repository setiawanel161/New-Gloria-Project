<header id="header" class="header d-flex align-items-center fixed-top" style="background-color: #10375C; padding-top: 5px; padding-bottom: 5px;">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a class="nav-link fs-6 my-2" href="/" style="color: #F4F6FF;">Beranda</a></li>
          <li><a class="nav-link fs-6 my-2" href="/layanan" style="color: #F4F6FF;">Layanan</a></li>
          <li><a class="nav-link fs-6 my-2" href="/about" style="color: #F4F6FF;">Tentang Kami</a></li>
        </ul>
